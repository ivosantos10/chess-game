...
public class Board {
    ...
    public void placePiece(Piece piece, Position position){ // Place a piece in the matrix
    ...
    public boolean positionExists (int row, int column){ // Verify if the position exists
        return row >= 0 && row < rows && column >= 0 && column < columns;
    }

    public boolean positionExists (Position position){ // Verify if the position exists
